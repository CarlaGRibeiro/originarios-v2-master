...
namespace Originarios.Controllers
{
    ...
    public class PublicacoesController : Controller
    {
        ...
        public ActionResult Create
        (
            [Bind(Include = "id_public,usuario,titulo,descricao,locali,nm_img1,vb_img1")] Publicacao publicacao,
            string base64_img1 
        )
        {
        ...
        (
            [Bind(Include = "id_public,usuario,titulo,descricao,locali,nm_img1,vb_img1,g")] Publicacao publicacao,
            string base64_img1
        )
        {
            if (ModelState.IsValid)
